    ...
    server: function () {
      function server() {
        return function (props) {
          ...
          var ctx = configureStore.server(localizedProps);
          var contents = _server2['default'].renderToString(_react2['default'].createElement(ctx.bootstrap(component)));
